(function () {
  ...
  function ensureChatbotMarkup() {
    ...
    wrapper.innerHTML = [
      '<button class="chatbot-trigger" id="chatbot-trigger-btn" aria-label="Open PNEC helper" aria-expanded="false">',
      '  <span class="chatbot-trigger-icon" aria-hidden="true">💬</span>',
      '  <span class="chatbot-trigger-label">Help</span>',
      '</button>',
      '<div class="chatbot-panel" id="chatbot-panel" role="dialog" aria-modal="true" aria-label="PNEC website helper">',
      '  <div class="chatbot-header">',
      '    <div class="chatbot-header-logo" aria-hidden="true">💬</div>',
      '    <div class="chatbot-header-title">',
      '      <div class="chatbot-name">PNEC Helper</div>',
      ...
      '          <input type="text" id="chatbot-search-input" placeholder="Ask a question..." aria-label="Ask PNEC Helper a question" autocomplete="off">',
      ...
      '      <div class="chatbot-conversation-input"><input type="text" id="chatbot-followup-input" placeholder="Ask a follow-up..." aria-label="Ask PNEC Helper a follow-up question" autocomplete="off"><button type="button" class="chatbot-send-btn" id="chatbot-followup-send-btn" aria-label="Send follow-up">➤</button></div>',
